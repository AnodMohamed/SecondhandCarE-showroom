        ...
        <section class="page-section breadcrumbs ">
            <div class="container">
                <div class="page-header">
                    <h2 class="section-title"><span>Add Ad</span></h2>
                    <ul class="breadcrumb">
            ...
            <form wire:submit.prevent="storeAd" name="contact-form"  class="contact-form" id="storeAd" enctype="multipart/form-data">
                ...
                <div class="outer required">
                    <div class="form-group af-inner"  >
                        ...
                        <input wire:model="file" type="file" name="file" id="file" placeholder="check up file" value=""  data-toggle="tooltip" title="" class="form-control " data-original-title="check up file is required">
                        @error('file')
                            <p class="text-danger">{{$message}}</p>
                        @enderror
                    </div>
                ...
                <div class="mb-6 col-8">
                    ...
                    <input type="file" placeholder="Product Image" class="form-control input-md input-file" wire:model="image"/>
                    @error('image')
                        <p class="text-danger">{{$message}}</p>
                    @enderror
                    @if ($image)
